...
export function IoK8sApiExtensionsV1beta1ReplicaSetSpecFromJSON(json: any): IoK8sApiExtensionsV1beta1ReplicaSetSpec {
    return {
...
export function IoK8sApiExtensionsV1beta1ReplicaSetSpecToJSON(value?: IoK8sApiExtensionsV1beta1ReplicaSetSpec): any {
    if (value === undefined) {
        return undefined;
    }
    return {
