...
export function IoK8sApiAppsV1beta1ControllerRevisionFromJSON(json: any): IoK8sApiAppsV1beta1ControllerRevision {
    return {
...
export function IoK8sApiAppsV1beta1ControllerRevisionToJSON(value?: IoK8sApiAppsV1beta1ControllerRevision): any {
    if (value === undefined) {
        return undefined;
    }
    return {
