...
export function IoK8sApiExtensionsV1beta1DaemonSetStatusFromJSON(json: any): IoK8sApiExtensionsV1beta1DaemonSetStatus {
    return {
        'collisionCount': !exists(json, 'collisionCount') ? undefined : json['collisionCount'],
        'conditions': !exists(json, 'conditions') ? undefined : (json['conditions'] as Array<any>).map(IoK8sApiExtensionsV1beta1DaemonSetConditionFromJSON),
...
export function IoK8sApiExtensionsV1beta1DaemonSetStatusToJSON(value?: IoK8sApiExtensionsV1beta1DaemonSetStatus): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'collisionCount': value.collisionCount,
        'conditions': value.conditions === undefined ? undefined : (value.conditions as Array<any>).map(IoK8sApiExtensionsV1beta1DaemonSetConditionToJSON),
