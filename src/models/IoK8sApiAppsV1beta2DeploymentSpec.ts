...
import {
    ...
    IoK8sApiAppsV1beta2DeploymentStrategyFromJSON,
    IoK8sApiAppsV1beta2DeploymentStrategyToJSON,
...
export function IoK8sApiAppsV1beta2DeploymentSpecFromJSON(json: any): IoK8sApiAppsV1beta2DeploymentSpec {
    return {
        ...
        'strategy': !exists(json, 'strategy') ? undefined : IoK8sApiAppsV1beta2DeploymentStrategyFromJSON(json['strategy']),
        'template': IoK8sApiCoreV1PodTemplateSpecFromJSON(json['template']),
    };
}

export function IoK8sApiAppsV1beta2DeploymentSpecToJSON(value?: IoK8sApiAppsV1beta2DeploymentSpec): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'strategy': IoK8sApiAppsV1beta2DeploymentStrategyToJSON(value.strategy),
