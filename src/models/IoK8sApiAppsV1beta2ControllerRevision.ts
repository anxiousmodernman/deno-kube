...
export function IoK8sApiAppsV1beta2ControllerRevisionFromJSON(json: any): IoK8sApiAppsV1beta2ControllerRevision {
    return {
...
export function IoK8sApiAppsV1beta2ControllerRevisionToJSON(value?: IoK8sApiAppsV1beta2ControllerRevision): any {
    if (value === undefined) {
        return undefined;
    }
    return {
