...
export function IoK8sApiStorageV1alpha1VolumeAttachmentSourceFromJSON(json: any): IoK8sApiStorageV1alpha1VolumeAttachmentSource {
    return {
...
export function IoK8sApiStorageV1alpha1VolumeAttachmentSourceToJSON(value?: IoK8sApiStorageV1alpha1VolumeAttachmentSource): any {
    if (value === undefined) {
        return undefined;
    }
    return {
