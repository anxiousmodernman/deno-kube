...
export function IoK8sApiStorageV1beta1VolumeAttachmentListFromJSON(json: any): IoK8sApiStorageV1beta1VolumeAttachmentList {
    return {
        'apiVersion': !exists(json, 'apiVersion') ? undefined : json['apiVersion'],
        'items': (json['items'] as Array<any>).map(IoK8sApiStorageV1beta1VolumeAttachmentFromJSON),
        'kind': !exists(json, 'kind') ? undefined : json['kind'],
        'metadata': !exists(json, 'metadata') ? undefined : IoK8sApimachineryPkgApisMetaV1ListMetaFromJSON(json['metadata']),
    };
}

export function IoK8sApiStorageV1beta1VolumeAttachmentListToJSON(value?: IoK8sApiStorageV1beta1VolumeAttachmentList): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'apiVersion': value.apiVersion,
        'items': (value.items as Array<any>).map(IoK8sApiStorageV1beta1VolumeAttachmentToJSON),
        'kind': value.kind,
