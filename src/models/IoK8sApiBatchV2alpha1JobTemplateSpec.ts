...
export function IoK8sApiBatchV2alpha1JobTemplateSpecFromJSON(json: any): IoK8sApiBatchV2alpha1JobTemplateSpec {
    return {
...
export function IoK8sApiBatchV2alpha1JobTemplateSpecToJSON(value?: IoK8sApiBatchV2alpha1JobTemplateSpec): any {
    if (value === undefined) {
        return undefined;
    }
    return {
