...
export function IoK8sApiAppsV1beta1DeploymentRollbackFromJSON(json: any): IoK8sApiAppsV1beta1DeploymentRollback {
    return {
        'apiVersion': !exists(json, 'apiVersion') ? undefined : json['apiVersion'],
        'kind': !exists(json, 'kind') ? undefined : json['kind'],
        'name': json['name'],
        'rollbackTo': IoK8sApiAppsV1beta1RollbackConfigFromJSON(json['rollbackTo']),
        'updatedAnnotations': !exists(json, 'updatedAnnotations') ? undefined : json['updatedAnnotations'],
    };
}

export function IoK8sApiAppsV1beta1DeploymentRollbackToJSON(value?: IoK8sApiAppsV1beta1DeploymentRollback): any {
    if (value === undefined) {
        return undefined;
    }
    return {
