...
import {
    ...
    IoK8sApimachineryPkgApisMetaV1InitializersToJSON,
...
export function IoK8sApimachineryPkgApisMetaV1ObjectMetaFromJSON(json: any): IoK8sApimachineryPkgApisMetaV1ObjectMeta {
    return {
        ...
        'initializers': !exists(json, 'initializers') ? undefined : IoK8sApimachineryPkgApisMetaV1InitializersFromJSON(json['initializers']),
...
export function IoK8sApimachineryPkgApisMetaV1ObjectMetaToJSON(value?: IoK8sApimachineryPkgApisMetaV1ObjectMeta): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'initializers': IoK8sApimachineryPkgApisMetaV1InitializersToJSON(value.initializers),
        'labels': value.labels,
