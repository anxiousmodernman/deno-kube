...
export function IoK8sApiStorageV1beta1StorageClassFromJSON(json: any): IoK8sApiStorageV1beta1StorageClass {
    return {
...
export function IoK8sApiStorageV1beta1StorageClassToJSON(value?: IoK8sApiStorageV1beta1StorageClass): any {
    if (value === undefined) {
        return undefined;
    }
    return {
