...
export function IoK8sApiRbacV1alpha1PolicyRuleFromJSON(json: any): IoK8sApiRbacV1alpha1PolicyRule {
    return {
...
export function IoK8sApiRbacV1alpha1PolicyRuleToJSON(value?: IoK8sApiRbacV1alpha1PolicyRule): any {
    if (value === undefined) {
        return undefined;
    }
    return {
