...
export function IoK8sApiAdmissionregistrationV1beta1ValidatingWebhookFromJSON(json: any): IoK8sApiAdmissionregistrationV1beta1ValidatingWebhook {
    return {
...
export function IoK8sApiAdmissionregistrationV1beta1ValidatingWebhookToJSON(value?: IoK8sApiAdmissionregistrationV1beta1ValidatingWebhook): any {
    if (value === undefined) {
        return undefined;
    }
    return {
