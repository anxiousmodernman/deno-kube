...
export function IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceSpecFromJSON(json: any): IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceSpec {
    return {
        ...
        'service': IoK8sKubeAggregatorPkgApisApiregistrationV1ServiceReferenceFromJSON(json['service']),
        'version': !exists(json, 'version') ? undefined : json['version'],
        'versionPriority': json['versionPriority'],
    };
}

export function IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceSpecToJSON(value?: IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceSpec): any {
    if (value === undefined) {
        return undefined;
    }
    return {
