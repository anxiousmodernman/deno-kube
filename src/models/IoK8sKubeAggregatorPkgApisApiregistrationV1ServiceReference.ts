...
export function IoK8sKubeAggregatorPkgApisApiregistrationV1ServiceReferenceToJSON(value?: IoK8sKubeAggregatorPkgApisApiregistrationV1ServiceReference): any {
    if (value === undefined) {
        return undefined;
    }
    return {
