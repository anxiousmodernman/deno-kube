...
import {
    ...
    IoK8sKubeAggregatorPkgApisApiregistrationV1beta1ServiceReferenceFromJSON,
    IoK8sKubeAggregatorPkgApisApiregistrationV1beta1ServiceReferenceToJSON,
} from './';
...
export function IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIServiceSpecFromJSON(json: any): IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIServiceSpec {
    return {
        ...
        'service': IoK8sKubeAggregatorPkgApisApiregistrationV1beta1ServiceReferenceFromJSON(json['service']),
        'version': !exists(json, 'version') ? undefined : json['version'],
        'versionPriority': json['versionPriority'],
    };
}

export function IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIServiceSpecToJSON(value?: IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIServiceSpec): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'service': IoK8sKubeAggregatorPkgApisApiregistrationV1beta1ServiceReferenceToJSON(value.service),
