...
export function IoK8sApiExtensionsV1beta1DeploymentConditionFromJSON(json: any): IoK8sApiExtensionsV1beta1DeploymentCondition {
    return {
...
export function IoK8sApiExtensionsV1beta1DeploymentConditionToJSON(value?: IoK8sApiExtensionsV1beta1DeploymentCondition): any {
    if (value === undefined) {
        return undefined;
    }
    return {
