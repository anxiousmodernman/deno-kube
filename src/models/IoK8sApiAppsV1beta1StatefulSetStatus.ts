...
import {
    ...
    IoK8sApiAppsV1beta1StatefulSetConditionFromJSON,
    IoK8sApiAppsV1beta1StatefulSetConditionToJSON,
} from './';
...
export function IoK8sApiAppsV1beta1StatefulSetStatusFromJSON(json: any): IoK8sApiAppsV1beta1StatefulSetStatus {
    return {
        'collisionCount': !exists(json, 'collisionCount') ? undefined : json['collisionCount'],
        'conditions': !exists(json, 'conditions') ? undefined : (json['conditions'] as Array<any>).map(IoK8sApiAppsV1beta1StatefulSetConditionFromJSON),
...
export function IoK8sApiAppsV1beta1StatefulSetStatusToJSON(value?: IoK8sApiAppsV1beta1StatefulSetStatus): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'collisionCount': value.collisionCount,
        'conditions': value.conditions === undefined ? undefined : (value.conditions as Array<any>).map(IoK8sApiAppsV1beta1StatefulSetConditionToJSON),
