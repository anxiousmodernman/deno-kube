...
import {
    ...
    IoK8sApiExtensionsV1beta1DeploymentStrategyFromJSON,
    IoK8sApiExtensionsV1beta1DeploymentStrategyToJSON,
...
export function IoK8sApiExtensionsV1beta1DeploymentSpecFromJSON(json: any): IoK8sApiExtensionsV1beta1DeploymentSpec {
    return {
        ...
        'rollbackTo': !exists(json, 'rollbackTo') ? undefined : IoK8sApiExtensionsV1beta1RollbackConfigFromJSON(json['rollbackTo']),
        'selector': !exists(json, 'selector') ? undefined : IoK8sApimachineryPkgApisMetaV1LabelSelectorFromJSON(json['selector']),
        'strategy': !exists(json, 'strategy') ? undefined : IoK8sApiExtensionsV1beta1DeploymentStrategyFromJSON(json['strategy']),
        'template': IoK8sApiCoreV1PodTemplateSpecFromJSON(json['template']),
    };
}

export function IoK8sApiExtensionsV1beta1DeploymentSpecToJSON(value?: IoK8sApiExtensionsV1beta1DeploymentSpec): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'strategy': IoK8sApiExtensionsV1beta1DeploymentStrategyToJSON(value.strategy),
