...
export function IoK8sApiAuthorizationV1beta1ResourceRuleFromJSON(json: any): IoK8sApiAuthorizationV1beta1ResourceRule {
    return {
...
export function IoK8sApiAuthorizationV1beta1ResourceRuleToJSON(value?: IoK8sApiAuthorizationV1beta1ResourceRule): any {
    if (value === undefined) {
        return undefined;
    }
    return {
