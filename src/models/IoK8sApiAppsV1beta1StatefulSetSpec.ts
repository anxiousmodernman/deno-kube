...
import {
    ...
    IoK8sApiAppsV1beta1StatefulSetUpdateStrategyFromJSON,
    IoK8sApiAppsV1beta1StatefulSetUpdateStrategyToJSON,
...
export function IoK8sApiAppsV1beta1StatefulSetSpecFromJSON(json: any): IoK8sApiAppsV1beta1StatefulSetSpec {
    return {
        ...
        'updateStrategy': !exists(json, 'updateStrategy') ? undefined : IoK8sApiAppsV1beta1StatefulSetUpdateStrategyFromJSON(json['updateStrategy']),
...
export function IoK8sApiAppsV1beta1StatefulSetSpecToJSON(value?: IoK8sApiAppsV1beta1StatefulSetSpec): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'updateStrategy': IoK8sApiAppsV1beta1StatefulSetUpdateStrategyToJSON(value.updateStrategy),
