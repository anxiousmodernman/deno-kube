...
export function IoK8sApiRbacV1alpha1AggregationRuleFromJSON(json: any): IoK8sApiRbacV1alpha1AggregationRule {
    return {
...
export function IoK8sApiRbacV1alpha1AggregationRuleToJSON(value?: IoK8sApiRbacV1alpha1AggregationRule): any {
    if (value === undefined) {
        return undefined;
    }
    return {
