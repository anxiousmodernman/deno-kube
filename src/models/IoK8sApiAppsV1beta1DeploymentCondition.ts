...
export function IoK8sApiAppsV1beta1DeploymentConditionFromJSON(json: any): IoK8sApiAppsV1beta1DeploymentCondition {
    return {
...
export function IoK8sApiAppsV1beta1DeploymentConditionToJSON(value?: IoK8sApiAppsV1beta1DeploymentCondition): any {
    if (value === undefined) {
        return undefined;
    }
    return {
