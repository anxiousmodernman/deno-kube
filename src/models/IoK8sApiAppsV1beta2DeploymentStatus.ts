...
export function IoK8sApiAppsV1beta2DeploymentStatusFromJSON(json: any): IoK8sApiAppsV1beta2DeploymentStatus {
    return {
        ...
        'conditions': !exists(json, 'conditions') ? undefined : (json['conditions'] as Array<any>).map(IoK8sApiAppsV1beta2DeploymentConditionFromJSON),
...
export function IoK8sApiAppsV1beta2DeploymentStatusToJSON(value?: IoK8sApiAppsV1beta2DeploymentStatus): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'conditions': value.conditions === undefined ? undefined : (value.conditions as Array<any>).map(IoK8sApiAppsV1beta2DeploymentConditionToJSON),
