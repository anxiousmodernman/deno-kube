...
export function IoK8sApiExtensionsV1beta1AllowedHostPathFromJSON(json: any): IoK8sApiExtensionsV1beta1AllowedHostPath {
    return {
...
export function IoK8sApiExtensionsV1beta1AllowedHostPathToJSON(value?: IoK8sApiExtensionsV1beta1AllowedHostPath): any {
    if (value === undefined) {
        return undefined;
    }
    return {
