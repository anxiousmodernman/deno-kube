...
import {
    ...
    IoK8sApiAppsV1beta2StatefulSetUpdateStrategyToJSON,
...
export function IoK8sApiAppsV1beta2StatefulSetSpecFromJSON(json: any): IoK8sApiAppsV1beta2StatefulSetSpec {
    return {
        ...
        'updateStrategy': !exists(json, 'updateStrategy') ? undefined : IoK8sApiAppsV1beta2StatefulSetUpdateStrategyFromJSON(json['updateStrategy']),
...
export function IoK8sApiAppsV1beta2StatefulSetSpecToJSON(value?: IoK8sApiAppsV1beta2StatefulSetSpec): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'updateStrategy': IoK8sApiAppsV1beta2StatefulSetUpdateStrategyToJSON(value.updateStrategy),
