...
export class CertificatesApi extends runtime.BaseAPI {
     ...
     */
    async getCertificatesAPIGroupRaw(): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1APIGroup>> {
     ...
     * get information of a group
     */
    async getCertificatesAPIGroup(): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup> {
        const response = await this.getCertificatesAPIGroupRaw();
