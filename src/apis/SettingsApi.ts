...
export class SettingsApi extends runtime.BaseAPI {
     ...
     */
    async getSettingsAPIGroupRaw(): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1APIGroup>> {
     ...
     * get information of a group
     */
    async getSettingsAPIGroup(): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup> {
        const response = await this.getSettingsAPIGroupRaw();
