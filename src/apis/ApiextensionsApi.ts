...
export class ApiextensionsApi extends runtime.BaseAPI {
     ...
     */
    async getApiextensionsAPIGroupRaw(): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1APIGroup>> {
     ...
     * get information of a group
     */
    async getApiextensionsAPIGroup(): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup> {
        const response = await this.getApiextensionsAPIGroupRaw();
