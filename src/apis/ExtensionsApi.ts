...
export class ExtensionsApi extends runtime.BaseAPI {
     ...
     */
    async getExtensionsAPIGroupRaw(): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1APIGroup>> {
     ...
     * get information of a group
     */
    async getExtensionsAPIGroup(): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup> {
        const response = await this.getExtensionsAPIGroupRaw();
