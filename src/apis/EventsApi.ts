...
export class EventsApi extends runtime.BaseAPI {
     ...
     */
    async getEventsAPIGroupRaw(): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1APIGroup>> {
     ...
     * get information of a group
     */
    async getEventsAPIGroup(): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup> {
        const response = await this.getEventsAPIGroupRaw();
