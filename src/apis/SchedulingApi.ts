...
export class SchedulingApi extends runtime.BaseAPI {
     ...
     */
    async getSchedulingAPIGroupRaw(): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1APIGroup>> {
     ...
     * get information of a group
     */
    async getSchedulingAPIGroup(): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup> {
        const response = await this.getSchedulingAPIGroupRaw();
