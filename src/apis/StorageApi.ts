...
export class StorageApi extends runtime.BaseAPI {
     ...
     */
    async getStorageAPIGroupRaw(): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1APIGroup>> {
     ...
     * get information of a group
     */
    async getStorageAPIGroup(): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup> {
        const response = await this.getStorageAPIGroupRaw();
