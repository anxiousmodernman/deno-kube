...
export class AuthorizationApi extends runtime.BaseAPI {
     ...
     */
    async getAuthorizationAPIGroupRaw(): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1APIGroup>> {
     ...
     * get information of a group
     */
    async getAuthorizationAPIGroup(): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup> {
        const response = await this.getAuthorizationAPIGroupRaw();
